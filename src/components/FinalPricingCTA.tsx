    ...
    <section className="py-10 md:py-14 bg-transparent text-[#F3EFE3] text-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-3xl relative z-10">
        ...
        <h2 className="text-3xl md:text-5xl font-bold font-heading text-[#F3EFE3] mb-5 leading-tight">
          More structure, more confidence, and better game days.
        </h2>
        <p className="text-lg text-[#A9B39E] mb-8 max-w-2xl mx-auto">
          Stop showing up unprepared. The Gridiron Guardian gives you the
          complete system to coach with clarity, lead with confidence, and
        ...
        <div className="bg-[#1E2E22] border border-[#D4A017]/20 rounded-3xl p-6 md:p-7 shadow-lg shadow-black/20 max-w-xl mx-auto mb-6">
          <h3 className="font-bold text-[#A8BB98] mb-2 text-sm md:text-base max-w-xs sm:max-w-none mx-auto">
            Complete Kit: The Gridiron Guardian + 5 Bonuses Included
          </h3>
          <div className="text-[#A9B39E] line-through mb-2">$97 USD</div>
          <div className="text-4xl font-bold text-[#C97A4A] mb-2">
            $27 USD
          </div>
          <p className="text-[#A9B39E] text-sm mb-6">
            One-time payment. Instant access. Works for any youth league.
          </p>
          <motion.a
            href={getCheckoutUrl()}
            whileHover={{
          ...
          >
            <span className="text-center">
              🚀 Yes, I Want My Gridiron Guardian Now
            </span>
