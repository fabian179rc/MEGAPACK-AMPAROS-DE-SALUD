      ...
      <div className="container mx-auto px-4 max-w-3xl text-center">
        ...
        <div className="bg-[#1E2E22] border border-[#D4A017]/20 rounded-3xl p-4 md:p-8 shadow-sm">
          <p className="text-sm md:text-base text-[#A9B39E] leading-relaxed mb-4 md:mb-6">
            You have 7 full days to review the complete system. If it
            doesn't match what was described, you can request a refund
            under the purchase conditions. Zero risk. Just results.
          </p>
